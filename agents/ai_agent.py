...
class AIAgent:
    def __init__(self):
        ...
        # This will be used for efficient similarity search of embeddings
        self.dimension = 384
    ...
    def respond(self, user_input):
        ...
        # Construct the prompt with retrieved context using PromptTemplate using Langchain prompt template
